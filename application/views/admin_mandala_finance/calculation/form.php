                        ...
                        <?php else: ?>
                            <?php foreach($list_dt_interest_5Year as $dt): ?>
                                <div class='form-group row'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input id="interest_value" required name='interests5Year[]' value="<?php echo $dt->dt_interest_value ?>" type='number' step='any' class='form-control' />
                                    </div>
                                </div>
                            <?php endforeach ?>
                            <div class="list_interest_5Year">
                        ...
                        <?php else: ?>
                            <?php foreach($list_dt_interest_10Year as $dt): ?>
                                <div class='form-group row'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input id="interest_value" required name='interests10Year[]' value="<?php echo $dt->dt_interest_value ?>" type='number' step='any' class='form-control' />
                                    </div>
                                </div>
                            <?php endforeach ?>
                            <div class="list_interest_10Year">
                        ...
                        <?php else: ?>
                            <?php foreach($list_dt_interest_15Year as $dt): ?>
                                <div class='form-group row'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input id="interest_value" required name='interests15Year[]' value="<?php echo $dt->dt_interest_value ?>" type='number' step='any' class='form-control' />
                                    </div>
                                </div>
                            <?php endforeach ?>
                            <div class="list_interest_15Year">
...
$(document).ready(function() {
    ...
    $('#add_interest_5Year').on('click', function(event) {
        ...
        $(".list_interest_5Year").append("<div class='form-group row'><div class ='col-md-3'><label>Interest (" + initialValue5Year + " Bulan" + ")</label></div><div class='col-sm-9'><input id='interest_value' name='interests5Year[]' required type='number' step='any' class='form-control' /></div></div>");
        $(".list_interest_10Year").append("<div class='form-group row'><div class ='col-md-3'><label>Interest (" + initialValue5Year + " Bulan" + ")</label></div><div class='col-sm-9'><input id='interest_value' name='interests10Year[]' required type='number' step='any' class='form-control' /></div></div>");
        $(".list_interest_15Year").append("<div class='form-group row'><div class ='col-md-3'><label>Interest (" + initialValue5Year + " Bulan" + ")</label></div><div class='col-sm-9'><input id='interest_value' name='interests15Year[]' required type='number' step='any' class='form-control' /></div></div>");
    ...
    $('#update_interest_5Year').on('click', function(event) {
        ...
        $(".list_interest_5Year").append("<div class='form-group row'><div class ='col-md-3'><label>Interest (" + initialValue5Year + " Bulan" + ")</label></div><div class='col-sm-9'><input id='interest_value' name='newInterests5Year[]' required type='number' step='any' class='form-control' /></div></div>");
        $(".list_interest_10Year").append("<div class='form-group row'><div class ='col-md-3'><label>Interest (" + initialValue5Year + " Bulan" + ")</label></div><div class='col-sm-9'><input id='interest_value' name='newInterests10Year[]' required type='number' step='any' class='form-control' /></div></div>");
        $(".list_interest_15Year").append("<div class='form-group row'><div class ='col-md-3'><label>Interest (" + initialValue5Year + " Bulan" + ")</label></div><div class='col-sm-9'><input id='interest_value' name='newInterests15Year[]' required type='number' step='any' class='form-control' /></div></div>");
