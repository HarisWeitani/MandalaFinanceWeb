    ...
    <div class="menu">
        <div class="menu-user-block">
            <div class="dropdown dropdown-avatar">
                ...
                <a class="dropdown-item" href="<?php echo base_url() . ADMIN_URL . ADMIN_URL_CHANGE_PASSWORD . "form/" . $this->session->userdata('admin_id'); ?>"><i class="dropdown-icon icmn-user"></i> Change Password</a>
